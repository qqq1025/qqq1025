...
<header>
    <div class="right">
        <ul>
            <li>
                <a href="${pageContext.request.contextPath}/stratPage.jsp.jsp?id=<%=id%>">首页</a>
            </li>
            <%--            <li>--%>
    ...
    <div class="left">
        <h2>修改失败，检查两次输入的密码是否一致</h2>
        <div class="back">
            <a href="${pageContext.request.contextPath}/queryallstudent?id=<%=id%>">返回首页</a>
        </div>
    </div>
</header>
</body>
