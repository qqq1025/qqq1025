...
<header>
    ...
    <div class="left">
        <form action="${pageContext.request.contextPath}/AdministorInsertBuilding" method="post">
            <table align="center" border="0" cellpadding="0" cellspacing="40">
                <tr>
                    ...
                    <td>
                        <input type="text" name="apartment" required placeholder="请输入楼号">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="introduction" required placeholder="请输入简介">
                    </td>
                </tr>
<%--                <tr>--%>
<%--                    <td>--%>
