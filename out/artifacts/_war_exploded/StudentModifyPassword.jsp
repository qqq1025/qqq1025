...
<%--            <li>--%>
<%--                <a href="${pageContext.request.contextPath}/querystudent2?id=${id}">学生查询</a>--%>
<%--            </li>--%>
            <li>
                <a href="${pageContext.request.contextPath}/queryallstudent?id=<%=id%>">返回</a>
            </li>
        </ul>
    </div>
    <div class="left">
        <form action="${pageContext.request.contextPath}/StudentModifyPassword?id=<%=id%>" method="post">
            <!-- <div class="title">
                <div class="search">
...
<%--            <div class="update">--%>
<%--                <label>楼&nbsp;&nbsp;&nbsp;</label>--%>
<%--                <input type="text" name="floor" required="required">--%>
<%--            </div>--%>
<%--            <div class="update">--%>
<%--                <label>寝室号</label>--%>
