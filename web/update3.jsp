...
<header>
    <div class="right">
        <ul>
            <li>
                <a href="${pageContext.request.contextPath}/queryallhousermaster">首页</a>
            </li>
            <%--            <li>--%>
    ...
    <div class="left">
        <form action="${pageContext.request.contextPath}/update3" method="post">
            <!-- <div class="title">
                <div class="search">
            ...
            <div class="update">
                <label>电话号码</label>
                <input type="text" name="phnum" required="required">
            </div>
            <div class="update">
                <label>管理楼层</label>
