...
<header>
    <div class="right">
        <ul>
            ...
            <li>
                <a href="${pageContext.request.contextPath}/HousemasterQueryAllabsentmsg?mfloor=${mfloor}">缺寝室记录查询</a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/HousemasterQueryabsentStu?mfloor=${mfloor}">缺寝记录</a>
            </li>
            <li>
    ...
    <div class="left">
        <div class="top">
            <form action="${pageContext.request.contextPath}/querysome?mfloor=${mfloor}" method="post">
                <div class="title">
                    <div class="search">
            ...
            <div class="insert">
                <a href="${pageContext.request.contextPath}/housemasterinsertstudent.jsp?mfloor=${mfloor}">新增</a>
            </div>
        </div>
        <div class="container">
            <table align="center" border="1" cellspacing="0" cellpadding="2px" width="100%" heigth="100%">
                ...
                <c:forEach var="Student" items="${allstudent}">
                    <tr>
                        ...
                        <td class="modify">
                            <a href="${pageContext.request.contextPath}/housemasterqueryupdatestu?id=${Student.id}&mfloor=${mfloor}">修改</a>
                            &nbsp;| &nbsp;
                            <a href="${pageContext.request.contextPath}/querysome2?id=${Student.id}&mfloor=${mfloor}">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
