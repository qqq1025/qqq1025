...
<header>
    ...
    <div class="left">
        <form action="${pageContext.request.contextPath}/AdministorSelfInsert" method="post">
            <table align="center" border="0" cellpadding="0" cellspacing="40">
                ...
                <tr>
                    <td>手机号</td>
                    <td>
                        <input type="text" name="phnum1"   required placeholder="请输入电话号码">
                    </td>
                </tr>
                <tr>
                    <td>密钥</td>
                    <td>
                        <input type="password" name="key" placeholder="请输入密钥">
                    </td>
                </tr>
                <div class="submit">
