...
<%--            </li>--%>
    ...
    <div class="left">
        ...
        <div class="container">
            <div class="qqq">
                <form action="${pageContext.request.contextPath}/HouseMasterDeleteAbsentMsg?mfloor=${mfloor}" method="post">
                    ...
                    <input type="hidden" name="id" id="id">
                    <div class="delete">
                        请输入密钥：<input type="password" name="key" class="key" maxlength="6">
                        <input type="submit" value="提交">
                    </div>
                </form>
            </div>
