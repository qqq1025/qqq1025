...
<header>
    <div class="right">
        <ul>
            ...
            <%--            </li>--%>
            <li>
                <a href="${pageContext.request.contextPath}/administorUpdateKeyword.jsp">返回</a>
            </li>
        </ul>
    </div>
    <div class="left">
        <h2>更新失败，请检查旧密钥是否正确</h2>
        <div class="back">
            <a href="${pageContext.request.contextPath}/administorStartPage.jsp">返回首页</a>
        </div>
    </div>
</header>
</body>
